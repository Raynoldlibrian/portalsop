...
export default function SopPortal() {
  ...
  return (
    <div className="min-h-screen bg-stone-50 font-sans" style={{ fontFamily: "'Inter', system-ui, sans-serif" }}>
      ...
      {view === "list" && (
      <header className="relative border-b border-stone-200 bg-teal-900 min-h-[460px]">
        <div className="absolute inset-0 overflow-hidden">
          <div className="relative max-w-4xl mx-auto px-6 h-full">
            {/* Background hero — foto Menara Air, kanan gambar sejajar batas kanan container (bukan layar) */}
            <img
            src="/hero-menara-air.jpg"
              alt=""
              className="absolute inset-y-0 right-6 h-full w-auto object-contain"
            />
          </div>
        </div>
